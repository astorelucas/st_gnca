...
class MultiScaleTemporalEncoding(nn.Module):
    ...
    def _compute_encoding(self, dt):
        ...
        # Split emb_dim across components
    ...
    def all(self):
        ...
        # print(f'All temporal embeddings shape: {torch.stack(embeddings_list).shape}')
        # print(f'Example embedding: {embeddings_list[0]}')
        return torch.stack(embeddings_list)  # [num_timesteps, emb_dim]
